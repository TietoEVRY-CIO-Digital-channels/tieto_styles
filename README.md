...
This styleguide is using the [SC5 styleguide tool](https://github.com/SC5/sc5-styleguide), so the files located in folder "styles-library" need to be developed in tandem with the styleguide definition files located in folder "style-guide". The gude (@TODO - what was meant by gude?!) watches all SCSS files and changes/reloads accordingly.
